...
namespace Library
{
	...
	int DataTimeHelper::DiffDay(const string INtime1, const string INtime2)
	{
		tm tm1 = ToTM(INtime1);
		tm tm2 = ToTM(INtime2);
	...
	int DataTimeHelper::DiffDay(time_t INtime1, time_t INtime2)
	{
		tm tm1 = GetTMTime(&INtime1);
		tm tm2 = GetTMTime(&INtime2);
	...
	int DataTimeHelper::GetWeekDay(time_t INtime)
	{
